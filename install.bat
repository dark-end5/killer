...
title Install Dependencies - Killer Bot (Node.js, FFmpeg, ImageMagick, Git, PM2, Yarn, etc.)
...
if exist "package.json" (
    echo %CYAN%[INFO] Found package.json. Running 'yarn install' for Killer Bot...%NC%
    call yarn install
) else (
...
echo ==========================================================
echo %PURPLE%[START] Starting Killer Bot...%NC%
call npm start
pause